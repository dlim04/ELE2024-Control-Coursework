...
\section*{Part A: Control Theory}
    \input{Report/Part A/Given Equations}
    \input{Report/Part A/Problem A1}
    \input{Report/Part A/Problem A2}
    \input{Report/Part A/Problem A3}
    \input{Report/Part A/Problem A4}
    \input{Report/Part A/Problem A5}
    
\section{Part B: Analysis and Controller Design}
    \input{Report/Part B/Problem B1}
    \input{Report/Part B/Problem B2}
    \input{Report/Part B/Problem B3}
    \input{Report/Part B/Problem B4}
    \input{Report/Part B/Problem B5}
    \input{Report/Part B/Problem B6}
    
\section{Part C: Bonus Questions}
    \input{Report/Part C/Problem C1}
    \input{Report/Part C/Problem C2}
    \input{Report/Part C/Problem C3}

\section{Part D: Planning, Organisation \& Collaboration}
    \input{Report/Part D/D1}
    \input{Report/Part D/D2}
    \input{Report/Part D/D3}
